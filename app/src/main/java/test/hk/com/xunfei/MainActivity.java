...
//			FlowerCollector.onEvent(this, "iat_recognize");
                et_input_msg.setText(null);// 清空显示内容
                mIatResults.clear();
                // 设置参数
                setParam();
...
//		et_input_msg.setText(text);
        ...
        et_input_msg.setText(resultBuffer.toString());
        et_input_msg.setSelection(et_input_msg.length());
    }
